# This prompt helps to extract information from a pdf document related to provided research questions. Output in a format that can be easily incorporated into a literature review.
```
